(function() {
  ...
  _.uniq = function(array) {
    ...
    _.each(array, function(item) {
      if (_.indexOf(duplicateFreeArray, item) === -1) {
  ...
  _.every = function(collection, iterator) {
    ...
    result = _.reduce(collection, function(result, value) {
      if(noIterator) {
        return (Boolean(value) && result);
      }
      else {
        return Boolean(iterator(value)) && result;
      }
    }, true);
  ...
  _.shuffle = function(array) {
    ...
    for(var i = 0; i < copyOfArray.length;i++) {
      var indexToSwapTo = getRandomInt(0,copyOfArray.length);
      var temp = copyOfArray[i];
      copyOfArray[i] = copyOfArray[indexToSwapTo];
      copyOfArray[indexToSwapTo] = temp;
    }
    return copyOfArray;
  };
